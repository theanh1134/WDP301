...
import { FaClipboardList, FaMoneyCheckAlt, FaTruck, FaBoxOpen, FaStar } from 'react-icons/fa';
                                ...
                                {(order.items || []).map((it, idx) => (
                                    <div key={idx} className="d-flex align-items-center justify-content-between py-2" style={{ borderBottom: '1px solid #f1f3f5' }}>
                                        <div className="d-flex align-items-center" style={{ gap: 12 }}>
                                            {it.thumbnailUrl && <img src={it.thumbnailUrl} alt={it.productName} style={{ width: 60, height: 60, borderRadius: 8, objectFit: 'cover', border: '1px solid #eee' }} />}
                                            <div>
