            ...
            <Container fluid style={styles.container}>
                ...
                <div style={styles.imageContainer}>
                    ...
                    <div style={styles.overlay}>
                        <h1 style={styles.overlayHeading}>Gửi Lại Mã Xác Nhận</h1>
                        <p style={styles.overlayText}>
                            Bạn chưa nhận được mã xác nhận? Hoặc mã đã hết hạn? Nhập email của bạn để nhận mã xác nhận mới.
                        </p>
                    </div>
                </div>

                {/* Right side - Resend Verification Form */}
                <div style={styles.formContainer}>
                    <div style={styles.formContent}>
                        <h1 style={styles.heading}>Gửi Lại Mã Xác Nhận</h1>
                        <div style={styles.headingUnderline}></div>
                        <p style={styles.subHeading}>Nhập email để nhận mã xác nhận mới</p>
                        ...
                        {success ? (
                            <div>
                                <div style={styles.successContainer}>
                                    ...
                                    <h2 style={styles.successTitle}>Mã xác nhận đã được gửi!</h2>
                                    <p style={styles.successMessage}>
                                        Chúng tôi đã gửi mã xác nhận mới đến email <strong>{email}</strong>.
